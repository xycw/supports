                ...
                <form method="post" action="<?php echo U('Marketing/Email/no_order_customers')?>" id="search-form">
                    <div class="form-inline">
                        <div class="form-group">
                            <label>网站</label>
                            <tagLib name="html" />
                            <html:select options="options_site_name" multiple="true" name="site_id[]" selected="site_id_select" />
                        </div>
                    </div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <select multiple="multiple" name="mail_api" class="form-control" style="height:200px;">
                    <?php
                    foreach ($send_mail_api as $k=>$api){
                        echo '<option value="'.$api.'"'.($k==0 ? ' selected="selected"' : '').'>'.$api.'</option>';
                    }
                    ?>
                </select>
            </div>
